...
public class RemoteAction extends Activity {
    ...
    private void performAction() throws RemoteException {
        Log.d(TAG, "performAction: called");

        /*Collection<VpnProfile> tempProfileList=ProfileManager.getInstance(this).getProfiles();
        Log.d(TAG, "performAction: list length:"+tempProfileList.size());
        for(VpnProfile profile:tempProfileList)
            Log.d(TAG, "performAction: vpn profie name:"+profile.mName);*/
