...
public class MainActivity extends BaseActivity {
    ...
    void createDefaultConfig(){
        ...
        try {
            //InputStream stream=getContentResolver().openInputStream(Uri.fromFile(new File("//android_asset/pathshalatest.ovpn")));
            InputStream stream=getAssets().open("pathshalatest.ovpn");
            ...
            try {
                ...
                profileManager.saveProfile(MainActivity.this, profile);
            } catch (IOException e) {
                e.printStackTrace();
            ...
            Log.d("MainActivity", "createDefaultConfig: "+e.getMessage());
        }
